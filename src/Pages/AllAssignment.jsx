...
const AllAssignment = () => {
    ...
    //console.log(setItemsPerPage, items);
    useEffect(() => {
        const getData = async () => {
            const { data } = await axios(`${import.meta.env.VITE_API_URL}/all-assignment?page=${currentPage}&size=${itemsPerPage}&filter=${filter}&sort=${sort}&search=${search}`
            )
            setItems(data)
        }
        getData()
    ...
    useEffect(() => {
        const getCount = async () => {
            const { data } = await axios(
                `${import.meta.env.VITE_API_URL}/assignment-count?filter=${filter}&search=${search}`
            )
